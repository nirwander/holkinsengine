<?php
	...
	define( "__DEBUG", 1 );
	define( "DS", "/" );
	define( "__ROOT_PATH", dirname(__FILE__).DS."b" );
	...
	require_once __ROOT_PATH.DS."Cache.class.php";
	...
	require_once __ROOT_PATH.DS."model".DS."mParty.class.php";
	require_once __ROOT_PATH.DS."model".DS."mVote.class.php";
	...
	if ( !$controller = $router->getController() ) return header( "Location: 404.html" );
